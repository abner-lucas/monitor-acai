  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 flex flex-col justify-center items-center px-4 py-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-slate-100 overflow-hidden relative z-10 animate-in fade-in zoom-in-95 duration-300">
        ...
        {/* Security Subheader */}
        <div className="px-6 py-2.5 bg-slate-50 border-b border-slate-100 flex items-center justify-center gap-1.5 text-[11px] font-semibold text-slate-600">
        ...
        <div className="p-6 sm:p-7 space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  autoComplete="email"
                  placeholder="abner.lucas@ifpa.edu.br"
                  value={email}
          ...
          <div className="p-3 bg-slate-50 border border-slate-200/70 rounded-xl flex items-start gap-2.5 text-[11px] text-slate-600">
