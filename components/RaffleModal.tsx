      ...
      >
        ...
        <div className="px-6 py-3.5 bg-gradient-to-r from-emerald-800 to-emerald-900 text-white flex items-center justify-between">
          ...
          <button
            ...
            className="p-1 rounded-lg text-emerald-200 hover:text-white hover:bg-white/10 transition-colors disabled:opacity-50"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          {availablePositions.length === 0 ? (
            ...
            <>
              ...
              <div className="mb-5 p-4 rounded-xl bg-slate-50 border border-emerald-200 text-center relative overflow-hidden">
                <div className="text-[11px] font-semibold text-emerald-800 uppercase tracking-wider mb-1 flex items-center justify-center gap-1">
